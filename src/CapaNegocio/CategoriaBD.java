...
public class CategoriaBD {
    ...
    public List<Categoria> reportarCategoria(){
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, e,"Erro al reportar usuarios BD...",JOptionPane.ERROR_MESSAGE);
            return null;
        }
             return lista;
}
    ...
    public boolean registrarCategoria(Categoria c){
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, e,"Problemas al Registrar categoriasBD...",JOptionPane.ERROR_MESSAGE);
            return rpta;
        }
        return rpta;
    }
